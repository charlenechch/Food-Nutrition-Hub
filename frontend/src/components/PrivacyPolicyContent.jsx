...
export default function PrivacyPolicyContent() {
   return (
    <div className="tpm-doc-body">
      ...
      <h3 className="tpm-doc-section">2. Who We Are</h3>
      ...
      <h3 className="tpm-doc-section">3. Information We Collect</h3>
      ...
      <h3 className="tpm-doc-section">4. How We Use Your Data</h3>
      ...
      <h3 className="tpm-doc-section">5. How We Store and Protect Your Data</h3>
      ...
      <h3 className="tpm-doc-section">6. Third-Party Services</h3>
      ...
      <h3 className="tpm-doc-section">7. Data Retention</h3>
      ...
      <h3 className="tpm-doc-section">8. Your Rights Under PDPA</h3>
      ...
      <h3 className="tpm-doc-section">9. Children's Privacy</h3>
      ...
      <h3 className="tpm-doc-section">10. Changes to This Policy</h3>
      ...
      <h3 className="tpm-doc-section">11. Contact Us</h3>
