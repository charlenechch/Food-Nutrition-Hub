          ...
          <div className="rdp-main">
            ...
            <div className="rdp-card3">
              <h3 className="rdp-sec-title">
                <ShoppingBasket className="rdp-sec-icon" size={16}  color="#6a4a2f" /> Ingredients
              </h3>
            ...
            <div className="rdp-card3">
              <h3 className="rdp-sec-title">
                <NotebookText className="rdp-sec-icon" size={16}  color="#6a4a2f" /> Instructions
              </h3>
          ...
          <aside className="rdp-aside">
            <div className="fdp-actions">
              ...
              <button
                ...
                onClick={handleShare}
              >
                <Share2 className="rdp-sec-icon" size={16}  />
              </button>
            </div>
            {recipe.funFact && (
              <div className="rdp-card3 rdp-note rdp-note-warm">
                <div className="rdp-note-head">
                  <Lightbulb className="rdp-sec-icon" size={16}  color="#6a4a2f" /> <span>Did You Know?</span>
                </div>
            ...
            {recipe.chefTips && (
              <div className="rdp-card3 rdp-note">
                <div className="rdp-note-head">
                  <ChefHat className="rdp-sec-icon" size={16}  color="#6a4a2f" /> <span>Chef's Tips</span>
                </div>
