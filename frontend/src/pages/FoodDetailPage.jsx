          ...
          <div className="fdp-left">
            ...
            <div className="fdp-card">
              <h3 className="rdp-sec-title">
                <Info className="rdp-sec-icon" size={14}   color={"#6a4a2f"}/> Cultural Heritage
              </h3>
            ...
            {ingredients.length > 0 && (
              <div className="fdp-card">
                <h3 className="rdp-sec-title">
                  <ShoppingBasket className="rdp-sec-icon" size={14}    color={"#6a4a2f"}/> Common Ingredients
                </h3>
          ...
          <div className="fdp-right">
            ...
            <div className="fdp-actions">
              <button type="button" className="lrp-btn lrp-btn-outline" onClick={goToRecipe}>
                <ScrollText className="rdp-sec-icon" size={14}    /> Go to Recipe
              </button>
            </div>
            ...
            <div className="fdp-card">
              <h3 className="rdp-sec-title">
                <Cross className="rdp-sec-icon" size={14}    color={"#6a4a2f"}/> Nutritional Information
              </h3>
            ...
            <div className="fdp-card">
              <div className="fdp-disc-header">
                <h3 className="rdp-sec-title">
                  <MessagesSquare className="rdp-sec-icon" size={14}    color={"#6a4a2f"}/> Community Discussion
                </h3>
              </div>
