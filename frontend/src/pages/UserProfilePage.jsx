...
const MOCK_USERS = {
  john: {
    ...
    prefs: {
      dietary: "none",         // 'none' | 'vegetarian' | 'vegan' | 'halal'
      allergies: "noAllergies",// 'noAllergies' | 'nutsAllergy' | 'seafoodAllergy' | 'spicyRestriction'
            ...
            {tab === "prefs" && (
                ...
                <div className="upp-card">
                    ...
                    {[
                        ...
                        <label key={id} className={`upp-choice ${prefs.dietary === id ? "is-on" : ""}`}>
                        <input
                            type="radio"
                            name="dietary"
                            value={id}
                            checked={prefs.dietary === id}
                ...
                <div className="upp-card">
                    ...
                    {[
                        ...
                        ["nutsAllergy", "Tree nuts"],
                        ["seafoodAllergy", "Seafood"],
                        ["spicyRestriction", "No spicy food"],
                    ].map(([id, label]) => (
                        <label key={id} className={`upp-choice ${prefs.allergies === id ? "is-on" : ""}`}>
                        <input
                            type="radio"
                            name="allergies"
                            value={id}
                            checked={prefs.allergies === id}
