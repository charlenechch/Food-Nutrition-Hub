...
const EditRecipePage = () => {
  ...
  // Mock recipe data (replace later with API or props)
  const mockRecipes = [
    {
      name: "Bubur Pedas Recipe",
      author: "Local Chef",
      email: "localchef@email.com",
      ...
      cooktime: "30", 
      foodtype: "Poultry", 
      englishDesc: "A traditional spicy porridge from Sarawak, often enjoyed during special occasions and ceremonies.",
      serving: "1", 
      ingredientsEN: "Rice, coconut milk, lemongrass, galangal, chicken, turmeric leaves",
      steps: [
        "Soak rice for 2 hours",
        "Blend spices with coconut milk",
        "Cook rice with spice mixture",
        "Add chicken and simmer",
        "Stir until creamy consistency",
      ],
      fact: "Family Recipe",
      tips: "Best served hot with keropok and pickled vegetables.",
      dietary: "Keto, Paleo",
    },
  ];
  ...
  const current = mockRecipes[index] || mockRecipes[0];
  console.log("Loaded recipe:", current); // 🔍 Debug check
  setRecipe(current);
}, [id]);
            ...
            <div className="review-main">
                ...
                <div className="review-section uploaded-image-card">
                    ...
                    <div className="uploaded-img-box">
                        <img
                        src="https://thumbs.dreamstime.com/z/kebab-fast-food-dish-22677562.jpg?ct=jpeg"
                        alt="Uploaded recipe"
