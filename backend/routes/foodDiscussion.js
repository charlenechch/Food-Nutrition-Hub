...
router.get('/food/:foodId/like-status', async (req, res) => {
  try {
    ...
    if (foodResult.length > 0) {
      ...
      console.log('🔵 Backend like-status - food data:', food);
      ...
      if (req.session && req.session.user) {
        ...
        console.log('🔵 Backend like-status - profileResult:', profileResult);
        ...
        if (profileResult.length > 0) {
          ...
          console.log('🔵 Backend like-status - likedBy:', likedBy);
          ...
          if (likedBy) {
            try {
              ...
              console.log('🔵 Backend like-status - isLiked:', isLiked);
            } catch (error) {
              console.error('Error parsing liked_by:', error);
            }
          }
